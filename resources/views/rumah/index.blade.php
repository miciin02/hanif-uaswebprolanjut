...
<div class="d-flex" style="font-family: 'Inter', sans-serif;">
    ...
    <main class="flex-grow-1 px-4 py-3" style="min-height: 100vh; background: #1e2a46;">
        <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3 text-white">
            <h3 class="mb-0 fw-semibold">Data Rumah</h3>
        ...
        @if(session('success'))
        <div class="alert glass-alert text-dark">{{ session('success') }}</div>
        @endif
        ...
        <div class="glass-card p-3 rounded-4 shadow-sm">
            ...
            <div class="table-responsive">
                <table class="table table-bordered align-middle text-center mb-0">
                    <thead style="background-color: rgba(255,255,255,0.4);" class="text-dark">
                        <tr>
                            <th>No</th>
                            <th>Kode Survey</th>
                            <th>Status Rumah</th>
            ...
            @else
            <div class="alert glass-alert text-dark text-center mb-0">Belum ada data rumah.</div>
            @endif
        </div>
    </main>
</div>
